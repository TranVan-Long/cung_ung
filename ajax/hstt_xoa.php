...
if ($id != "" && $user_id != "" && $com_id != "") {
    ...
    $delete_ycvt = new db_query("DELETE FROM `ho_so_thanh_toan` WHERE `id` = '$id' AND `id_cong_ty` = $com_id ");
} else {
    echo "Bạn xóa phiếu hồ sơ thanh toán không thành công, vui lòng thử lại";
}
