...
$body = '<div style="width: 724px; float: left; background: #FFFFFF; padding: 90px 40px; border-radius: 8px;">
            ...
            <div style="width: 100%; float: left;">
                ...
                <p style="style="font-size: 14px; line-height: 16px; color: #474747; width: 100%; float: left; margin-bottom: 8px; margin-top: 0;"">' . $com_name . '</p>
                <h4 style="width: 100%; float: left; margin-bottom: 8px; font-size: 14px; line-height: 16px; color: #474747; margin-top: 0;">Bên bán</h4>
                <p style="style="font-size: 14px; line-height: 16px; color: #474747; width: 100%; float: left; margin-bottom: 8px; margin-top: 0;"">' . $ncc['ten_nha_cc_kh'] . '</p>
                <p style="style="font-size: 14px; line-height: 16px; color: #474747; width: 100%; float: left; margin-bottom: 8px; margin-top: 0;"">Sau khi bàn bạc, trao đổi hai bên thống nhất ký kết Hợp đồng với các điều khoản sau:</p>
                <div style="width: 100%; float: left; margin-bottom: 24px;">
                    ...
                    <p style="style="font-size: 14px; line-height: 16px; color: #474747; width: 100%; float: left; margin-bottom: 8px; margin-top: 0;"">' . $hd_detail['noi_dung_hd'] . '</p>
                </div>
                ...
                <div style="width: 100%; float: left; margin-bottom: 24px;">
                    ...
                    <p style="style="font-size: 14px; line-height: 16px; color: #474747; width: 100%; float: left; margin-bottom: 8px; margin-top: 0;"">' . $hd_detail['yc_tien_do'] . '</p>
                </div>
                <div style="width: 100%; float: left; margin-bottom: 24px;">
                    ...
                    <p style="style="font-size: 14px; line-height: 16px; color: #474747; width: 100%; float: left; margin-bottom: 8px; margin-top: 0;"">' . $hd_detail['dieu_khoan_tt'] . '</p>
                </div>
                <div style="width: 100%; float: left; margin-bottom: 24px;">
                    ...
                    <p style="style="font-size: 14px; line-height: 16px; color: #474747; width: 100%; float: left; margin-bottom: 8px; margin-top: 0;"">' . $hd_detail['noi_dung_luu_y'] . '</p>
                </div>
            </div>
        </div>';
//Gửi mail
