...
if ($cou == 0) {
    ...
    if ($cou != $cou1 || $cou1 != $cou2) {
        ...
        $inser_bg = new db_query("INSERT INTO `yeu_cau_bao_gia`(`id`, `id_nguoi_lap`, `nha_cc_kh`, `id_cong_trinh`, `id_nguoi_tiep_nhan`,
                            ...
                            '$noi_dung_ph','','','$ngay_bd','$ngay_kt','',2,1,'$ngay_tao','','$com_id') ");
        ...
        $log = new db_query("INSERT INTO `nhat_ky_hd`(`id`, `id_nguoi_dung`, `ngay_tao`,`gio_tao`, `noi_dung`) VALUES('', '$user_id', '$ngay_tao','$gio_tao', '$nd_nhatk')");
    }
} else {
