...
if ($ngay_ky_hd != "" && $id_nha_cung_cap != "") {
    if($count > 0){
        if($count != $count2){
            echo "Điền đầy đủ thông tin vật tư và số lượng lớn hơn 0";
            ...
            $them_hd_ban = new db_query("INSERT INTO `hop_dong` (`id`, `ngay_ky_hd`, `id_nha_cc_kh`,`id_du_an_ctrinh`, `hd_nguyen_tac`, `hinh_thuc_hd`,
                                ...
                                `phan_loai`, `trang_thai`,`ngay_tao`,`quyen_nlap`, `nguoi_lap`, `id_cong_ty`) VALUES (NULL,'$ngay_ky_hd','$id_nha_cung_cap',
                                '$dan_ctrinh', '$hd_nguyen_tac',
                                ...
                                '$noi_dung_luu_y', '$dieu_khoan_tt','$ten_nh', '$so_taik','$bao_gia','$tthuan_hdon', '$phan_loai','$trang_thai','$ngay_tao',
                                '$role','$user_id','$com_id')");
        ...
        echo "Thêm mới ít nhất 1 vật tư";
    }
