...
if ($ngay_ky_hd != "" && $id_nha_cung_cap != "" && $count > 0 && $count == $count2) {
    $them_hd_ban = new db_query("INSERT INTO `hop_dong` (`id`, `ngay_ky_hd`, `id_nha_cc_kh`,`id_du_an_ctrinh`, `hd_nguyen_tac`, `hinh_thuc_hd`, `gia_tri_trvat`, `bao_gom_vat`, `thue_vat`,`tien_chiet_khau`, `gia_tri_svat`,`giu_lai_bhanh`,`gia_tri_bhanh`,`bao_lanh_hd`,`gia_tri_blanh`,`thoi_han_blanh`, `tg_bd_thuc_hien`, `tg_kt_thuc_hien`, `bgom_vchuyen`, `yc_tien_do`,`noi_dung_hd`, `noi_dung_luu_y`, `dieu_khoan_tt`, `ten_ngan_hang`, `so_tk`,`id_bao_gia`,`thoa_tuan_hoa_don`,`phan_loai`, `trang_thai`, `id_cong_ty`) VALUES (NULL,'$ngay_ky_hd','$id_nha_cung_cap','$dan_ctrinh', '$hd_nguyen_tac','$hinh_thuc','$truoc_vat', '$don_gia_vat','$thue_vat','$chiet_khau','$sau_vat','$bao_hanh','$gt_bao_hanh','$bao_lanh','$gt_bao_lanh','$han_bao_lanh', '$ngay_bat_dau', '$ngay_ket_thuc', '$bao_gom_van_chuyen', '$yc_tiendo', '$noi_dung_hd', '$noi_dung_luu_y', '$dieu_khoan_tt','$ten_nh', '$so_taik','$bao_gia','$tthuan_hdon', '$phan_loai','$trang_thai', '$com_id')");
