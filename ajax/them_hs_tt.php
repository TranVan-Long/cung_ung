...
else if($com_id != "" && $hd_dh != "" && $loai_hs != "" && $tong_tien_ky_nay != ""){

    $inser_hs = new db_query("INSERT INTO `ho_so_thanh_toan`(`id`, `id_hd_dh`, `loai_hs`, `dot_nghiem_thu`, `tg_nghiem_thu`, `thoi_han_thanh_toan`,
                            `tong_tien_tt`, `chi_phi_khac`, `trang_thai`, `ngay_tao`, `ngay_chinh_sua`, `id_nguoi_lap`, `id_cong_ty`)
                            VALUES ('','$hd_dh','$loai_hs','$dot_nthu','$thoig_nthu','$thoi_han_tt','$tong_tien_ky_nay','$chi_phi_khac','1','$ngay_tao','','$user_id','$com_id')");
