...
if ($com_id != "" && $user_id != "" && $id_dg != "" && ($cou1 > 0 || $co1 > 0)) {
    if ($cou1 > 0 && $co1 == 0) {
        ...
        if ($co1 != $co2 || $co2 != $co3 || $co3 != $co4) {
            ...
            $up_dg = new db_query("UPDATE `danh_gia` SET `id_nha_cc`='$id_nhacc',`danh_gia_khac`='$dg_khac' WHERE `id` = $id_dg AND `id_cong_ty` = $com_id ");
