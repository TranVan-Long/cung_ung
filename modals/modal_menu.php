                        ...
                        <? if (isset($_SESSION['quyen']) && $_SESSION['quyen'] == 1) { ?>
                            ...
                            <li class="collapse share_cursor <?= (in_array($_SERVER['REDIRECT_URL'], $all_hopd)) ? "active" : "" ?>" data-tab="subt-menu1">
                                ...
                                <ul id="subt-menu1" class="<?= (in_array($_SERVER['REDIRECT_URL'], $all_hopd)) ? "active" : "" ?>">
                                    ...
                                    <li>
                                        <a href="quan-ly-don-hang.html" class="<?= (in_array($_SERVER['REDIRECT_URL'], $don_hang)) ? "active" : ""  ?>"><span><?php echo $ic_circle ?></span>Đơn
                                            hàng</a>
                                    </li>
                                    <li>
                                        <a href="quan-ly-ho-so-thanh-toan.html" class="<?= (in_array($_SERVER['REDIRECT_URL'], $ho_so_tt)) ? "active" : "" ?>"><span><?php echo $ic_circle ?></span>Hồ
                                            sơ thanh toán</a>
                                    </li>
                                    <li>
                                        <a href="quan-ly-phieu-thanh-toan.html" class="<?= (in_array($_SERVER['REDIRECT_URL'], $phieu_tt)) ? "active" : "" ?>"><span><?php echo $ic_circle ?></span>Phiếu
                                            thanh toán</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="collapse share_cursor share_height <?= (in_array($_SERVER['REDIRECT_URL'], $all_ncc)) ? "active" : "" ?>" data-tab="subt-menu3">
                                ...
                                <ul id="subt-menu3" class="<?= (in_array($_SERVER['REDIRECT_URL'], $all_ncc)) ? "active" : "" ?>">
                                    <li>
                                        <a href="quan-ly-nha-cung-cap.html" class="<?= (in_array($_SERVER['REDIRECT_URL'], $nha_cc)) ? "active" : "" ?>"><span><?php echo $ic_circle ?></span>Nhà
                                            cung cấp</a>
                                    </li>
                                    <li>
                                        <a href="danh-gia-nha-cung-cap.html" class="<?= (in_array($_SERVER['REDIRECT_URL'], $danhg_ncc)) ? "active" : "" ?>"><span><?php echo $ic_circle ?></span>Đánh
                                            giá nhà cung cấp</a>
                                    </li>
                                    <li>
                                        <a href="tieu-chi-danh-gia.html" class="<?= (in_array($_SERVER['REDIRECT_URL'], $tieuc_dg)) ? "active" : "" ?>"><span><?php echo $ic_circle ?></span>Tiêu
                                            chí đánh giá</a>
                                    </li>
                                </ul>
                            </li>
