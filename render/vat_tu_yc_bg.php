...
?>
    ...
    <td class="w-15">
        <div class="v-select2">
            <select name="ten_vat_tu" class="share_select ten_vat_tu" onchange="doi_vt(this)" data="<?= $com_id ?>">
    ...
    <td class="w-15">
        <? if ($id != "") { ?>
            <input type="text" name="so_luong_vt" oninput="<?= $oninput ?>" placeholder="Nhập số lượng phải lớn hơn 0">
        <? } else { ?>
            <input type="text" name="so_luong_vt" readonly>
        <? } ?>
    </td>
...
<? } else { ?>
    ...
    <td class="w-15">
        <? if ($id != "") { ?>
            <input type="text" name="so_luong" oninput="<?= $oninput ?>" placeholder="Nhập số lượng phải lớn hơn 0">
        <? } else { ?>
