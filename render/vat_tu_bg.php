...
?>
        <tr class="item" data-id="<?= $row['id'] ?>">
            ...
            <td class="w-25">
                <input type="text" name="so_luong_bao_gia" oninput="<?= $oninput ?>" class="tex_center so_luong" onkeyup="sl_doi(this)">
            </td>
            <td class="w-25">
                <input type="text" name="don_gia" class="tex_center don_gia" oninput="<?= $oninput ?>" onkeyup="dg_doi(this)">
            </td>
            <td class="w-30">
                <input type="text" name="tong_truoc_vat" class="tex_center tong_trvat" readonly>
            </td>
            <td class="w-25">
                <input type="text" oninput="<?= $oninput ?>" name="thue_vat" class="tex_center thue_vat" onkeyup="thue_doi(this)">
            </td>
            <td class="w-30">
