                        ...
                        <tbody>
                            <? while ($row1 = mysql_fetch_assoc($ds_vt->result)) {
                                ...
                                <tr>
                                    ...
                                    <td class="w-10">
                                        <input type="text" name="kl_luy_ke_ky_nay" oninput="<?= $oninput ?>" value="<?= $all_vt['kl_ky_nay'] ?>" class="tex_center" onkeyup="sl_hs_doi(this)">
                                    </td>
                                    <td class="w-10">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="w-10">
                                    <input type="text" name="kl_luy_ke_ky_nay" oninput="<?= $oninput ?>" value="<?= $all_vt['kl_ky_nay'] ?>" class="tex_center" onkeyup="klt_hs_doi(this)">
                                </td>
                                <td class="w-10">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="w-10">
                                    <input type="text" name="kl_luy_ke_ky_nay" oninput="<?= $oninput ?>" value="<?= $all_vt['kl_ky_nay'] ?>" class="tex_center" onkeyup="kl_hs_doi(this)">
                                </td>
                                <td class="w-10">
