...
if($id_com != 0){
    $qr_ycvt = new db_query("SELECT `id`, `id_nguoi_yc`, `role`, `id_cong_trinh`, `ngay_ht_yc`, `dien_giai`, `trang_thai`,
                            `id_kho`, `ly_do_tu_choi`, `id_nguoi_duyet`, `id_cong_ty` FROM `yeu_cau_vat_tu`
