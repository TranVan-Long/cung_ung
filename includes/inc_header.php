<div class="bg_wra">
    ...
    <div class="bg_ima">
        <a href="https://timviec365.vn">
            <img src="../img/logo.png" rel="nofollow", alt="timviec365.vn">
        </a>
    </div>
        ...
        <div class="nav">
            ...
            <div class="hd_log">
                ...
                ?>
                    ...
                    <? }
                } else if (!isset($_COOKIE['acc_token']) || !isset($_COOKIE['role']) || !isset($_COOKIE['rf_token'])) { ?>
                    <div class="bg_log">
                        <p>
                            <a href="https://quanlychung.timviec365.vn/lua-chon-dang-ky.html" rel="nofollow" class="cr_weight_bold share_fsize_tow share_clr_tow">Đăng ký</a>
                            /
                            <a href="https://quanlychung.timviec365.vn/lua-chon-dang-nhap.html" rel="nofollow" class="cr_weight_bold share_fsize_tow share_clr_tow">Đăng nhập</a>
                        </p>
                    </div>
                <? } ?>
            </div>
