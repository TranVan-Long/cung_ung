                            ...
                            <form action="" class="form_add_hp_mua share_distance w_100 float_l" data="<?= $role ?>" data1="<?= $com_id ?>" data2="<?= $user_id ?>" data3="<?= $hd_id ?>">
                                ...
                                <div class="form-row w_100 float_l">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="thue_vat" oninput="<?= $oninput ?>" value="<?= $hd_detail['thue_vat'] ?>" class="form-control thue_vat_tong" onkeyup="thue_vc_doi(this)" placeholder="Nhập thuế suất VAT">
                                    </div>
                                </div>
                                <div class="form-row w_100 float_l">
                                    <div class="form-group">
                                ...
                                <div class="form-row w_100 float_l">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="hmuc_tind" oninput="<?= $oninput ?>" value="<?= $hd_detail['han_muc_tin_dung'] ?>" class="form-control" placeholder="Nhập hạn mức tín dụng">
                                    </div>
                                </div>
                                ...
                                <div class="form-row w_100 float_l">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="so_taik" oninput="<?= $oninput ?>" value="<?= $hd_detail['so_tk'] ?>" class="form-control" placeholder="Nhập số tài khoản">
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr class="item">
                                                        ...
                                                        <td class="share_tb_three">
                                                            <div class="form-group">
                                                                <input type="text" name="khoi_luong_old" oninput="<?= $oninput ?>" value="<?= $vt_vc_fetch['khoi_luong'] ?>" placeholder="Khối lượng phải lớn hơn 0" class="form-control so_luong" onkeyup="sl_vc_doi(this),tong_hd_vc()">
                                                            </div>
                                                        </td>
                                                        <td class="share_tb_four">
                                                            <div class="form-group">
                                                                <input type="text" name="don_gia_old" oninput="<?= $oninput ?>" value="<?= $vt_vc_fetch['don_gia'] ?>" placeholder="Đơn giá vật tư phải lớn hơn 0" class="form-control don_gia" onkeyup="dg_vc_doi(this),tong_hd_vc()">
                                                            </div>
                                                        </td>
                                                        <td class="share_tb_four">
                                                            <div class="form-group">
