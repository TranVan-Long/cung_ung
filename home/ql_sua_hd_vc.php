                            ...
                            <form action="" class="form_add_hp_mua share_distance w_100 float_l" method="">
                                ...
                                <div class="form-row w_100 float_l">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="hmuc_tind" value="<?= $hd_detail['han_muc_tin_dung'] ?>" class="form-control" placeholder="Nhập hạn mức tín dụng">
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr class="item">
                                                        ...
                                                        <td class="share_tb_three">
                                                            <div class="form-group">
                                                                <input type="text" name="khoi_luong_old" value="<?= $vt_vc_fetch['khoi_luong'] ?>" class="form-control so_luong" onkeyup="sl_doi(this),tong_vt(), baoLanh(),baoHanh()">
                                                            </div>
                                                        </td>
                                                        <td class="share_tb_four">
                                                            <div class="form-group">
                                                                <input type="text" name="don_gia_old" value="<?= $vt_vc_fetch['don_gia'] ?>" class="form-control don_gia" onkeyup="dg_doi(this),tong_vt(), baoLanh(),baoHanh()">
                                                            </div>
                                                        </td>
                                                        <td class="share_tb_four">
                                                            <div class="form-group">
                                                                <input type="hiden" name="vat_ao" value="0" class="share_dnone thue_vat">
                                                                <input type="text" name="thanh_tien_old" value="<?= $vt_vc_fetch['thanh_tien'] ?>" class="form-control h_border tong_svat" readonly>
                                                            </div>
                                                        </td>
                                                    </tr>
    ...
    $('.add_vat_tu').click(function() {
        var html = `<tr class="item">
                        ...
                        <td class="share_tb_four">
                            <div class="form-group">
                                <input type="hiden" name="vat_ao" value="0" class="share_dnone thue_vat" >
                                <input type="text" name="thanh_tien" class="form-control h_border tong_svat" readonly>
                            </div>
                        </td>
                    </tr>`;
