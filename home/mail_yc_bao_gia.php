...
<body style="font-family: roboto;">
    <div class="ctn_hop_dong">
        ...
        <p style="width: 100%; float: left; text-align: center; margin-bottom: 25px; font-size: 14px; line-height: 16px; color: #474747">Kính gửi: <span style="font-weight: 500">{Nha_Cung_Cap}</span></p>
        <div class="chi_tiet">
            ...
            <table class="table">
                <tr>
                    ...
                    <th class="thead_th_two" style="width: 53%">Vật tư</th>
                    <th class="thead_th_three" style="width: 20%">Đơn vị tính</th>
                    <th class="thead_th_four" style="width: 20%; border-top-right-radius: 10px; border-right: 1px solid transparent">Số lượng</th>
                </tr>
            ...
            <h4 style="width:100%; float:left">Mail nhận: {Mail_Nhan_Bao_Gia}</h4>
        </div>
    </div>
</body>
</html>