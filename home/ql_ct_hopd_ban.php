                ...
                <div class="ctn_ctiet_hd w_100 float_l">
                    <div class="chi_tiet_hd mt_27 w_100 float_l" data="<?= $phan_quyen_nk ?>" data1="<?= $user_id ?>">
                        ...
                        <div class="ctiet_dk_hp w_100 float_l" data="<?= $com_id ?>">
                            ...
                            <div class="chitiet_hd w_100 float_l">
                                <div class="ctiet_hd_left float_l pl-10">
                                    <p class="ten_ctiet share_fsize_tow share_clr_one">Khách hàng</p>
                            ...
                            <div class="chitiet_hd w_100 float_l">
                                <div class="ctiet_hd_left float_l pl-10">
                                    ...
                                    <p class="cr_weight share_fsize_tow share_clr_one"><?= ($hd_detail['yc_tien_do']) ? "" . $hd_detail['yc_tien_do'] . "" : "Không có" ?></p>
                                </div>
                            </div>
                            <div class="chitiet_hd w_100 float_l">
                                <div class="ctiet_hd_left float_l pl-10">
                                    <p class="ten_ctiet share_fsize_tow share_clr_one">Nội dung hợp đồng</p>
                                    <p class="cr_weight share_fsize_tow share_clr_one noi_dung"><?= ($hd_detail['noi_dung_hd']) ? "" . $hd_detail['noi_dung_hd'] . "" : "Không có" ?></p>
                                </div>
                            </div>
                            <div class="chitiet_hd w_100 float_l">
                                <div class="ctiet_hd_left float_l pl-10">
                                    <p class="ten_ctiet share_fsize_tow share_clr_one">Nội dung cần lưu ý</p>
                                    <p class="cr_weight share_fsize_tow share_clr_one"><?= ($hd_detail['noi_dung_luu_y']) ? "" . $hd_detail['noi_dung_luu_y'] . "" : "Không có" ?></p>
                                </div>
                            </div>
                            <div class="chitiet_hd w_100 float_l">
                                <div class="ctiet_hd_left float_l pl-10">
                                    <p class="ten_ctiet share_fsize_tow share_clr_one">Điều khoản thanh toán</p>
                                    <p class="cr_weight share_fsize_tow share_clr_one"><?= ($hd_detail['dieu_khoan_tt']) ? "" . $hd_detail['dieu_khoan_tt'] . "" : "Không có" ?></p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="info_modal">
                <div class="modal-header">
                    <div class="header_ctn_share">
                        <h4 class="ctn_share_h share_clr_tow tex_center cr_weight_bold">XÓA HỢP ĐỒNG BÁN</h4>
                        ...
                        <div class="madal_form">
                            ...
                            <div class="form_butt_ht mb_20">
                                <div class="tow_butt_flex d_flex">
                                    <button type="button" class="js_btn_huy share_cursor mb_10 btn_d share_w_148 share_clr_four share_bgr_tow share_h_36">Hủy</button>
                                    <button type="button" class="share_w_148 mb_10 share_cursor share_clr_tow share_h_36 sh_bgr_six save_new_dp xoa_hd_ban" data-id="<?= $hd_id ?>">Đồng
                                        ý</button>
                                </div>
                            </div>
                        </div>
