                    ...
                    <div class="form-row left">
                        <div class="form-col-50 left">
                            ...
                            <div class="d-flex align-items-center spc-btw w-100 left">
                                <div class="w-40">
                                    <input class="date-input-sm" type="date" id="ap-dung-tu" name="ap-dung-tu" value="2021-10-18">
                                </div>
                                <p class="mt-5">đến</p>
                                <div class="w-40">
                                    <input class="date-input-sm" type="date" id="ap-dung-den" name="ngay-gui" value="2022-05-05">
                                </div>
                            </div>
                        </div>
                    </div>
