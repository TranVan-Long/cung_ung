                    ...
                    <div class="ctn_body_modal">
                        <div class="madal_form">
                            <div class="ctiet_pop mt_20">
                                <p class="share_fsize_tow share_clr_one">Bạn có chắc chắn muốn hủy việc sửa đơn hàng bán?</p>
...
<script>
    $(".all_nhacc, .all_nguoilh, .all_da_ct, .all_hd, .ma_vatt, .ten_vatt").select2({
        width: '100%',
    });
