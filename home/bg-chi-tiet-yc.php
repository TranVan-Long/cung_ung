                ...
                <div class="left w-100 mt-50">
                    ...
                    <div class="control-btn right">
                        <? if (isset($_SESSION['quyen']) && $_SESSION['quyen'] == 1) { ?>
                            ...
                            if (in_array(4, $yc_baogia)) { ?>
                                <button class="v-btn btn-outline-red modal-btn mr-20 mt-30" data-id="<?= $id_bg ?>">Xóa</button>
                            <? }
                            if (in_array(3, $yc_baogia)) { ?>
                                <a href="chinh-sua-yeu-cau-bao-gia-<?= $id_bg ?>.html" class="v-btn btn-blue mt-30">Chỉnh sửa</a>
                        <? }
                        } ?>
                    </div>
                    <div class="control-btn left mr-10">
                        <button class="v-btn btn-gray mr-20 mt-30 gui_mail" data1="<?= $id_bg ?>" data2="<?= $com_id ?>">Gửi mail</button>
                        <button class="v-btn btn-green mt-30 xuat_excel" data="<?= $id_bg ?>">Xuất exel</button>
                    </div>
                </div>
            </div>
        </div>
