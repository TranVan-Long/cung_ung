...
if (isset($_COOKIE['acc_token']) && isset($_COOKIE['rf_token']) && isset($_COOKIE['role'])) {
    if ($_COOKIE['role'] == 1) {
        ...
        if (mysql_num_rows($kiem_tra_nv->result) > 0) {
            ...
            if (in_array(3, $bao_gia_kh) == FALSE) {
                        ...
                        <div class="form-control edit-form">
                            ...
                            <div class="form-row left">
                                <div class="w-100 no-border left">
                                    ...
                                    <textarea name="noi_dung_phan_hoi" cols="30" rows="10" placeholder="Nhập nội dung phản hồi"><?= $list_phieu['noi_dung_thu'] ?></textarea>
                                </div>
                            </div>
                        </div>
            ...
            <div class="m-content">
                ...
                <div class="m-foot d-inline-block">
                    ...
                    <div class="right mb_10">
                        <a href="chi-tiet-bao-gia-cho-khach-hang-<?= $id ?>.html" class="v-btn sh_bgr_six share_clr_tow right">Đồng
                            ý</a>
                    </div>
                </div>
            </div>
