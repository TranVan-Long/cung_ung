                                ...
                                <div class="nd_chitiet d_flex fl_wrap">
                                    <div class="nd_one">
                                        <div class="nd_ctiet_nho d_flex">
                                            ...
                                            <p class="nd_nho share_fsize_four share_clr_one tex_left">Vấn đề vật tư tại công trường
                                    ...
                                    <div class="nd_three">
                                        <div class="nd_ctiet_nho d_flex">
                                            <img src="../img/icon_tat.png" alt="vấn đề gặp phải">
                                            <p class="nd_nho">Vấn đề vật tư tại công trường
                                                chưa được quản lý chặt chẽ có thể gây nguy cơ
                                                thất thoát vật tư, thi công vượt định mức
                                            </p>
                                        </div>
                                ...
                                <div class="ctn_tatca w_100 d_flex fl_nwrap">
                                    <div class="tinhn_one">
                                        <div class="ctn_ctiet_tnang">
                                            ...
                                            <p class="share_fsize_tow share_clr_one">Quản lý cung ứng, xuất nhập vật tư</p>
                                        </div>
                                    </div>
                                    <div class="tinhn_one tinhn_one_o">
                                        <div class="ctn_ctiet_tnang">
                                            ...
                                            <p class="share_fsize_tow share_clr_one">Quản lý hợp đồng, thanh quyết toán</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tnghiem_one float_l">
                                        ...
                                        <div class="avt_tnghiem w_100 float_l d_flex">
                                            <div class="avt_white w_100 float_l d_flex">
                                                ...
                                                <div class="tnghiem_image_o">
                                                    <p><img src="../img/gg_play.png" alt="trải nghiệm ngay trên app"></p>
                                                    <p><img src="../img/gg_app.png" alt="trải nghiệm ngay trên app"></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
