    ...
    <div class="container">
        ...
        <div class="content">
            <div class="mt-20 left">
                ...
                <h5 class="text-blue mt-20">Chi tiết Khách hàng</h5>
            </div>
                ...
                <div class="form-control">
                    <div class="form-row left">
                        <div class="form-col-50 left">
                            ...
                            <p class="right text-right w-50 text-bold">KH-000-99999</p>
                        </div>
                        <div class="form-col-50 right">
                            <p class="left text-left w-50">Tên gọi tắt</p>
                            <p class="right text-right w-50 text-bold">NVA</p>
                        </div>
                    </div>
                    <div class="form-row left border-top2">
                        ...
                        <div class="form-col-50 right">
                            ...
                            <p class="right text-right w-50 text-bold">NVA01</p>
                        </div>
                    </div>
                    <div class="form-row left border-top2">
                        <div class="form-col-50 left">
                    ...
                    <div class="form-row left border-top2">
                        ...
                        <div class="form-col-50 right">
                            ...
                            <p class="right text-right w-50 text-bold">15339876543210</p>
                        </div>
                    </div>
                    <div class="form-row left border-top2">
                        <div class="form-col-50 left">
                    ...
                    <div class="form-row left border-top2">
                        <div class="form-col-50 left">
                            <p class="left text-left w-50">Mã số thuế</p>
                            <p class="right text-right w-50 text-bold">009927363528</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-100 left">
                ...
                <div class="right mt-30">
                    ...
                    <a href="kh-edit.php" class="v-btn btn-blue ml-20">Chỉnh sửa</a>
                </div>
            </div>
            <div class=""></div>
        </div>
