                    ...
                    <div class="chi_tiet_cd mt_25 w_100 float_l">
                        <div class="top_sett w_100 float_l">
                            <div class="ctn_top_sett w_100 float_l">
                                <p class="caidc_ql"><a href="quan-ly-cai-dat-nhan-vien.html" class="cai_dtl">Cài đặt chung</a></p>
                                <p class="his_ql active"><a href="nhat-ky-hoat-dong-nhan-vien.html" class="cai_dtl">Nhật ký hoạt động</a></p>
                            </div>
                        </div>
                        <div class="ctn_sett w_100 float_l">
                            ...
                            <div class="ctiet_nhatk share_bgr_tow w_100 float_l">
                                <div class="ctn_ctiet_nky">
                                    <p class="dropd_ctiet w_100 float_l"><span class="mr_10">Hôm nay</span> <img src="../img/exp.png" alt="" class="avt_dropd share_cursor"></p>
                                    <div class="ctiet_nd_nhatk w_100 float_l d_flex">
